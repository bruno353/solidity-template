...
contract OrbeGenesis is ERC721URIStorage, Ownable {
    ...
    constructor (uint256 _maxSupply) ERC721("TBT - ORBE GENESIS", "OG") {
    ...
    function mint(string memory uri, uint256 _category, address _address) public payable returns(uint256){
        require(ownerGovernance == msg.sender, "You are not the ownerGovernance");
    ...
    function returnMyOwner() public view returns(address){
        return owner();
    }
